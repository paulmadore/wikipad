...
#include <wikipad/wikipad-style-scheme-action.h>
...
static void       wikipad_action_group_finalize                         (GObject                *object);
static void       wikipad_action_group_set_property                     (GObject                *object,
                                                                          guint                   prop_id,
                                                                          const GValue           *value,
                                                                          GParamSpec             *pspec);
static void       wikipad_action_group_get_property                     (GObject                *object,
                                                                          guint                   prop_id,
                                                                          GValue                 *value,
                                                                          GParamSpec             *pspec);
...
wikipad_action_group_class_init (MousepadActionGroupClass *klass)
{
  ...
  g_object_class->finalize = wikipad_action_group_finalize;
  g_object_class->set_property = wikipad_action_group_set_property;
  g_object_class->get_property = wikipad_action_group_get_property;
  ...
  g_object_class_install_property (
    ...
    g_param_spec_object ("active-style-scheme",
                         ...
                         WIKIPAD_TYPE_STYLE_SCHEME_ACTION,
                         G_PARAM_READWRITE));
...
wikipad_action_group_finalize (GObject *object)
{
  ...
  self = WIKIPAD_ACTION_GROUP (object);
  ...
  G_OBJECT_CLASS (wikipad_action_group_parent_class)->finalize (object);
}



static void
wikipad_action_group_set_property (GObject      *object,
                                    guint         prop_id,
                                    const GValue *value,
                                    GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_ACTIVE_LANGUAGE:
      wikipad_action_group_set_active_language (self, g_value_get_object (value));
      break;
    case PROP_ACTIVE_STYLE_SCHEME:
      wikipad_action_group_set_active_style_scheme (self, g_value_get_object (value));
      break;
    default:
...
static void
wikipad_action_group_get_property (GObject    *object,
                                    guint       prop_id,
                                    GValue     *value,
                                    GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_ACTIVE_LANGUAGE:
      g_value_set_object (value, wikipad_action_group_get_active_language (self));
      break;
    case PROP_ACTIVE_STYLE_SCHEME:
      g_value_set_object (value, wikipad_action_group_get_active_style_scheme (self));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
...
wikipad_action_group_init (MousepadActionGroup *self)
{
  ...
  wikipad_action_group_add_language_actions (self);
  wikipad_action_group_set_active_language (self, NULL);

  self->active_scheme = NULL;
  wikipad_action_group_add_style_scheme_actions (self);

  /* set the initial style scheme from the setting */
  scheme_id = WIKIPAD_SETTING_GET_STRING (COLOR_SCHEME);
  scheme = gtk_source_style_scheme_manager_get_scheme (
              gtk_source_style_scheme_manager_get_default (), scheme_id);
  g_free (scheme_id);
  wikipad_action_group_set_active_style_scheme (self, scheme);

  /* update the colour scheme when the setting changes */
  WIKIPAD_SETTING_CONNECT_OBJECT (COLOR_SCHEME,
                                   G_CALLBACK (wikipad_action_group_color_scheme_setting_changed),
                                   self,
                                   G_CONNECT_SWAPPED);
}
...
GtkActionGroup *
wikipad_action_group_new (void)
{
  return g_object_new (WIKIPAD_TYPE_ACTION_GROUP, "name", "WikipadWindow", NULL);
}
                                           ...
                                           GtkSourceLanguage   *language)
{
  ...
  g_return_if_fail (WIKIPAD_IS_ACTION_GROUP (self));
  ...
  action = wikipad_action_group_get_language_action (self, language);
                                               ...
                                               GtkSourceStyleScheme *scheme)
{
  ...
  action = wikipad_action_group_get_style_scheme_action (self, scheme);
  ...
  self->locked = TRUE;
  WIKIPAD_SETTING_SET_STRING (COLOR_SCHEME, scheme_name);
  self->locked = FALSE;
                                               ...
                                               const gchar         *section)
{
  ...
  language_ids = wikipad_action_group_get_sorted_languages_for_section (section);
...
wikipad_action_group_create_language_menu (MousepadActionGroup *self)
{
  ...
  action = gtk_action_group_get_action (GTK_ACTION_GROUP (self), "wikipad-language-none");
  item = gtk_action_create_menu_item (action);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  gtk_widget_show (item);
  ...
  sections = wikipad_action_group_get_sorted_section_names ();
  ...
  for (iter = sections; iter != NULL; iter = g_slist_next (iter))
    {
      ...
      submenu = wikipad_action_group_create_language_submenu (self, section);
...
wikipad_action_group_create_style_scheme_menu (MousepadActionGroup *self)
{
  ...
  action = wikipad_action_group_get_style_scheme_action (self, NULL);
  item = gtk_action_create_menu_item (action);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  gtk_widget_show (item);
  ...
  schemes = wikipad_action_group_style_schemes_get_sorted ();
                                                ...
                                                WikipadLanguageAction *action)
{
  ...
  if (! self->locked &&
      gtk_toggle_action_get_active (GTK_TOGGLE_ACTION (action)))
    {
      ...
      language = wikipad_language_action_get_language (action);
      wikipad_action_group_set_active_language (self, language);

      /* notify interested parties that the user explicitly set the */
                                                    ...
                                                    MousepadStyleSchemeAction *action)
{
  ...
  if (! self->locked &&
      gtk_toggle_action_get_active (GTK_TOGGLE_ACTION (action)))
    {
      ...
      scheme = wikipad_style_scheme_action_get_style_scheme (action);
      wikipad_action_group_set_active_style_scheme (self, scheme);
    }
}
...
wikipad_action_group_add_language_actions (MousepadActionGroup *self)
{
  ...
  action = wikipad_language_action_new (NULL);
  gtk_radio_action_set_group (GTK_RADIO_ACTION (action), group);
  group = gtk_radio_action_get_group (GTK_RADIO_ACTION (action));
  gtk_action_set_accel_group (action, accel_group);
  gtk_action_group_add_action_with_accel (GTK_ACTION_GROUP (self), action, NULL);
  g_signal_connect_object (action, "activate", G_CALLBACK (wikipad_action_group_language_action_activate), self, G_CONNECT_SWAPPED);
  ...
  for (lang_id_ptr = lang_ids; lang_id_ptr && *lang_id_ptr; lang_id_ptr++)
    {
      ...
      action = wikipad_language_action_new (language);
      gtk_radio_action_set_group (GTK_RADIO_ACTION (action), group);
      group = gtk_radio_action_get_group (GTK_RADIO_ACTION (action));
      gtk_action_set_accel_group (action, accel_group);
      gtk_action_group_add_action_with_accel (GTK_ACTION_GROUP (self), action, NULL);
                                           ...
                                           GtkSourceLanguage   *language)
{
  ...
  action_name = g_strdup_printf ("wikipad-language-%s", language_id);
...
static gint
wikipad_action_group_languages_name_compare (gconstpointer a,
                                              gconstpointer b)
{
...
static GSList *
wikipad_action_group_get_sorted_section_names (void)
{
  GSList                   *list = NULL;
...
static GSList *
wikipad_action_group_get_sorted_languages_for_section (const gchar *section)
{
  GSList                   *list = NULL;
  const gchar *const       *languages;
  GtkSourceLanguage        *language;
  ...
  return g_slist_sort(list, (GCompareFunc) wikipad_action_group_languages_name_compare);
}
...
wikipad_action_group_add_style_scheme_actions (MousepadActionGroup *self)
{
  ...
  action = wikipad_style_scheme_action_new (NULL);
  gtk_radio_action_set_group (GTK_RADIO_ACTION (action), group);
  group = gtk_radio_action_get_group (GTK_RADIO_ACTION (action));
  gtk_action_set_accel_group (action, accel_group);
  gtk_action_group_add_action_with_accel (GTK_ACTION_GROUP (self), action, NULL);
  g_signal_connect_object (action, "activate", G_CALLBACK (wikipad_action_group_style_scheme_action_activate), self, G_CONNECT_SWAPPED);

  schemes = wikipad_action_group_get_style_schemes ();
  ...
  for (iter = schemes; iter != NULL; iter = g_slist_next (iter))
    {
      ...
      action = wikipad_style_scheme_action_new (scheme);
      gtk_radio_action_set_group (GTK_RADIO_ACTION (action), group);
      group = gtk_radio_action_get_group (GTK_RADIO_ACTION (action));
      gtk_action_set_accel_group (action, accel_group);
      gtk_action_group_add_action_with_accel (GTK_ACTION_GROUP (self), action, NULL);
                                               ...
                                               GtkSourceStyleScheme *scheme)
{
  ...
  name = g_strdup_printf ("wikipad-style-scheme-%s", scheme_id);
...
static gint
wikipad_action_group_style_schemes_name_compare (gconstpointer a,
                                                  gconstpointer b)
{
  const gchar *name_a, *name_b;
...
static GSList *
wikipad_action_group_get_style_schemes (void)
{
  GSList               *list = NULL;
...
static GSList *
wikipad_action_group_style_schemes_get_sorted (void)
{
  return g_slist_sort (wikipad_action_group_get_style_schemes (),
                       wikipad_action_group_style_schemes_name_compare);
}
