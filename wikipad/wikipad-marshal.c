...
void
_wikipad_marshal_VOID__INT_INT_INT (GClosure     *closure,
...
void
_wikipad_marshal_INT__FLAGS_STRING_STRING (GClosure     *closure,
                                           GValue       *return_value G_GNUC_UNUSED,
                                           guint         n_param_values,
                                           const GValue *param_values,
                                           gpointer      invocation_hint G_GNUC_UNUSED,
                                           gpointer      marshal_data)
{
  typedef gint (*GMarshalFunc_INT__FLAGS_STRING_STRING) (gpointer     data1,
                                                         guint        arg_1,
                                                         gpointer     arg_2,
                                                         gpointer     arg_3,
                                                         gpointer     data2);
  GMarshalFunc_INT__FLAGS_STRING_STRING callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
  gint v_return;
  ...
  callback = (GMarshalFunc_INT__FLAGS_STRING_STRING) (marshal_data ? marshal_data : cc->callback);
...
void
_wikipad_marshal_VOID__OBJECT_INT_INT (GClosure     *closure,
                                       GValue       *return_value G_GNUC_UNUSED,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint G_GNUC_UNUSED,
