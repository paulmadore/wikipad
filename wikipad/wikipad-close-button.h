...
#define WIKIPAD_CLOSE_BUTTON(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), WIKIPAD_TYPE_CLOSE_BUTTON, MousepadCloseButton))
#define WIKIPAD_CLOSE_BUTTON_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), WIKIPAD_TYPE_CLOSE_BUTTON, MousepadCloseButtonClass))
...
#define WIKIPAD_CLOSE_BUTTON_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), WIKIPAD_TYPE_CLOSE_BUTTON, MousepadCloseButtonClass))
