...
#ifndef __dbus_glib_marshal_wikipad_dbus_service_MARSHAL_H__
#define __dbus_glib_marshal_wikipad_dbus_service_MARSHAL_H__
...
/* BOOLEAN:POINTER */
extern void dbus_glib_marshal_wikipad_dbus_service_BOOLEAN__POINTER (GClosure     *closure,
                                                                     GValue       *return_value,
...
void
dbus_glib_marshal_wikipad_dbus_service_BOOLEAN__POINTER (GClosure     *closure,
...
extern void dbus_glib_marshal_wikipad_dbus_service_BOOLEAN__STRING_BOXED_POINTER (GClosure     *closure,
                                                                                  GValue       *return_value,
                                                                                  guint         n_param_values,
                                                                                  const GValue *param_values,
                                                                                  gpointer      invocation_hint,
                                                                                  gpointer      marshal_data);
void
dbus_glib_marshal_wikipad_dbus_service_BOOLEAN__STRING_BOXED_POINTER (GClosure     *closure,
                                                                      GValue       *return_value G_GNUC_UNUSED,
                                                                      guint         n_param_values,
                                                                      const GValue *param_values,
                                                                      gpointer      invocation_hint G_GNUC_UNUSED,
                                                                      gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__STRING_BOXED_POINTER) (gpointer     data1,
                                                                  ...
                                                                  gpointer     arg_3,
                                                                  gpointer     data2);
  GMarshalFunc_BOOLEAN__STRING_BOXED_POINTER callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
  gboolean v_return;
...
#endif /* __dbus_glib_marshal_wikipad_dbus_service_MARSHAL_H__ */
