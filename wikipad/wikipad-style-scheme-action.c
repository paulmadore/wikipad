...
static void wikipad_style_scheme_action_finalize         (GObject      *object);
static void wikipad_style_scheme_action_set_property     (GObject      *object,
                                                           guint         prop_id,
                                                           const GValue *value,
                                                           GParamSpec   *pspec);
static void wikipad_style_scheme_action_get_property     (GObject      *object,
                                                           guint         prop_id,
                                                           GValue       *value,
                                                           GParamSpec   *pspec);
...
wikipad_style_scheme_action_class_init (MousepadStyleSchemeActionClass *klass)
{
  ...
  g_object_class->finalize = wikipad_style_scheme_action_finalize;
  g_object_class->set_property = wikipad_style_scheme_action_set_property;
  g_object_class->get_property = wikipad_style_scheme_action_get_property;
...
wikipad_style_scheme_action_finalize (GObject *object)
{
  ...
  self = WIKIPAD_STYLE_SCHEME_ACTION (object);

  if (GTK_SOURCE_IS_STYLE_SCHEME (self->scheme))
    g_object_unref (self->scheme);

  G_OBJECT_CLASS (wikipad_style_scheme_action_parent_class)->finalize (object);
}



static void
wikipad_style_scheme_action_set_property (GObject      *object,
                                           guint         prop_id,
                                           const GValue *value,
                                           GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_STYLE_SCHEME:
      wikipad_style_scheme_action_set_style_scheme (self, g_value_get_object (value));
      break;
    default:
...
static void
wikipad_style_scheme_action_get_property (GObject    *object,
                                           guint       prop_id,
                                           GValue     *value,
                                           GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_STYLE_SCHEME:
      g_value_set_object (value, wikipad_style_scheme_action_get_style_scheme (self));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
...
GtkAction *
wikipad_style_scheme_action_new (GtkSourceStyleScheme *scheme)
{
  ...
  action = g_object_new (WIKIPAD_TYPE_STYLE_SCHEME_ACTION,
                         "name", name,
